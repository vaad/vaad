...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'apt_id'); ?>
		<?php echo $form->dropDownList($model, 'apt_id', GxHtml::listDataEx(Appartments::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'reminder_time'); ?>
